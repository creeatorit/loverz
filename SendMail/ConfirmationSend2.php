...
$pdo = Banco::conectar();
$sql233 = 'SELECT * FROM usuarios WHERE confirmado = "1" AND email="'.$_SESSION['EmailUsuario2'] .'" ORDER by id DESC LIMIT 1';
...
<p><font color="#999999" face="Arial, Helvetica, sans-serif">Deseja confirmar 
  seu cadastro?</font></p>
<p><a href="http://www.loverz.com.br/RegisterConfirmation.php" target="_blank"><img src="http://webapp137465.ip-50-116-30-45.cloudezapp.io/SendMail/images/botao_confirmar.fw.png" width="200" height="50" border="0"></a></p>
<p>&nbsp;</p>
