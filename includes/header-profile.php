		...
		<div class="control-block">
			...
			<div class="control-icon more has-items">
				...
				<div class="more-dropdown more-with-triangle triangle-top-center">
					<div class="ui-block-title ui-block-title-small">
						<h6 class="title">SOLICITAÇÕES DE AMIZADE</h6>
					</div>
					...
					<a href="#" class="view-all bg-blue">Visualizar todas as solicitações...</a>
				</div>
			</div>
			...
			<div class="control-icon more has-items">
				...
				<div class="more-dropdown more-with-triangle triangle-top-center">
					...
					<a href="#" class="view-all bg-primary">Visualizar todas as notificações...</a>
				</div>
			</div>
			<?php } ?>
			...
			<div class="author-page author vcard inline-items more">
				<div class="author-thumb">
					<img alt="author" src="images/tmp/<?php echo $data['foto'];?>" class="avatar" style="width: 40px; height: 40px;">
					...
					<div class="more-dropdown more-with-triangle">
						<div class="mCustomScrollbar" data-mcs-theme="dark">
							...
							<div class="ui-block-title ui-block-title-small">
								<h6 class="title">Customizar apelido</h6>
							</div>

							<form class="form-group with-button custom-status" method="POST">
								<input class="form-control" placeholder="" type="text" name="apelido" id="apelido" value="<?php echo $_SESSION['UsuarioApelido'] ?>">

								<button class="bg-purple" type="submit" name="atualiza_apelido">
									<svg class="olymp-check-icon"><use xlink:href="svg-icons/sprites/icons.svg#olymp-check-icon"></use></svg>
								</button>
							</form>
							-->
							<div class="ui-block-title ui-block-title-small">
								<h6 class="title">A Loverz</h6>
							</div>
				...
				<?php } ?>
					...
					<span class="author-subtitle"><?php echo $_SESSION['UsuarioApelido'] ?></span>
				</a>
			</div>
