...
$(function($) {
	...
	$("#formulario").submit(function() {
		...
		$("#status").html("<img class='container-avatar' src='img/loader.gif' alt='Postando...' />");
		// Fazemos a requisão ajax com o arquivo envia.php e enviamos os valores de cada campo através do método POST
		$.post('salvar_post.php', {post_text: post_text }, function(resposta) {
				...
				// Se resposta for false, ou seja, não ocorreu nenhum erro
					...
					$("#status").html("Post publicado com sucesso!");
					// Coloca a mensagem no div de mensagens
					$("#mensagens").prepend("<strong>"+ post_text +"</strong><br />");
...
<script type="text/javascript">
	$(window).load(function () { $("#countdown").fadeOut(2000); })
</script>
		...
		<main class="col col-xl-6 order-xl-2 col-lg-12 order-lg-1 col-md-12 col-sm-12 col-12">
			...
			<div class="ui-block">
				...
				<div class="news-feed-form">
					...
					<!-- Tab panes -->
					<div class="tab-content" id="escrever">
						<div class="tab-pane active" id="home-1" role="tabpanel" aria-expanded="true">
							<form id="formulario" action="javascript:func()"  method="POST">
								<div class="author-thumb">
									<img src="images/tmp/<?php echo $data['foto'];?>" alt="author" style="width: 40px; height: 40px;">
								</div>
								<div class="form-group with-icon label-floating is-empty">
									<!-- <label class="control-label"></label> -->
									<textarea class="form-control" placeholder="No que você está pensando agora?..." name="post_text" id="post_text"></textarea>
								</div>
								<div class="add-options-message">
									<a href="#" class="options-message" data-toggle="tooltip" data-placement="top"   data-original-title="ADD FOTOS / VÍDEOS">
									...
									<button class="btn btn-primary btn-md-2" type="submit">Publicar</button>
						...
						<div class="tab-pane" id="profile-1" role="tabpanel" aria-expanded="true">
							<form>
								...
								<div class="form-group with-icon label-floating is-empty">
									...
									<textarea class="form-control" placeholder="No que você está pensando agora?..." name="post_multimidia" id="post_multimidia"></textarea>
								</div>
								<div class="add-options-message">
									<a href="#" class="options-message" data-toggle="tooltip" data-placement="top"   data-original-title="ADD FOTOS / VÍDEOS">
										<svg class="olymp-camera-icon" data-toggle="modal" data-target="#update-header-photo"><use xlink:href="svg-icons/sprites/icons.svg#olymp-camera-icon"></use></svg>
			...
			<?php
				...
				LEFT JOIN usuarios
				ON posts.usuario_id = usuarios.id ORDER By dt_hr_postagem DESC";

				foreach ($pdo->query($sql_posts) as $row_posts) {
			?>

			<div id="countdown">
	
				<!-- <div class="ui-block" id="mensagens"> -->
				<div class="ui-block">

					<article class="hentry post">
					
						<div class="post__author author vcard inline-items">
							<img src="images/tmp/<?php echo $row_posts['foto']; ?>" alt="author" style="width: 40px; height: 40px;">
					
							<div class="author-date">
								<a class="h6 post__author-name fn" href="#"><?php echo $row_posts['apelido']; ?></a>
								<div class="post__date">
									<time class="published" datetime="2004-07-24T18:18">
										<?php
										$datatime1 = new DateTime($row_posts['dt_hr_postagem']);
						...
						<p><?php if($row_posts['post_text'] != '-'){ echo $row_posts['post_text']; } if($row_posts['post_multimidia'] != '-') { echo $row_posts['post_multimidia']; } ?></p>
					...
					<ul class="comments-list">
						<li class="comment-item">
							<div class="post__author author vcard inline-items">
								<img src="images/tmp/<?php echo $row_posts['foto']; ?>" alt="author">
					
								<div class="author-date">
									<a class="h6 post__author-name fn" href="02-ProfilePage.html"><?php echo $row_posts['apelido']; ?></a>
									<div class="post__date">
										<time class="published" datetime="2004-07-24T18:18">
											38 mins ago
										</time>
					...
					<a href="#" class="more-comments">Visualizar todos os comentários <span>+</span></a>
					...
					<form class="comment-form inline-items">
						...
						<button class="btn btn-md-2 btn-primary">Postar Comentário</button>
